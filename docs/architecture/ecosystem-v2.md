...
`@devilgenius/airgate-theme` 负责设计 token 和 theme/CSS helper。
...
| Phase 2 | 拆分 SDK 概念 | 逻辑上区分 `airgate-protocol`、`airgate-sdk-go`、`airgate-plugin-runtime-go`、`airgate-devkit-go`、`@airgate/plugin-ui`、`@devilgenius/airgate-theme` |
