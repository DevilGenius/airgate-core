...
export const usageApi = {
  ...
  stats: (params: { group_by?: string; include_summary?: boolean; start_date?: string; end_date?: string; platform?: string; model?: string; user_id?: number; api_key_id?: number }, options?: UsageRequestOptions) =>
