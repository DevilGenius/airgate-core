...
func TestSchedulingModelsForOpenAIAnthropicMessagesFableUsesSpecificEnv(t *testing.T) {
	clearSchedulingModelEnv(t)
	...
	got := schedulingModelsForRequest("openai", "/v1/messages", "claude-fable-5")
...
func TestSchedulingModelsForOpenAIAnthropicMessagesFableIgnoresOpusEnv(t *testing.T) {
	clearSchedulingModelEnv(t)
	t.Setenv("AIRGATE_MODEL_OPUS", "openai/gpt-5.5-opus")
	t.Setenv("AIRGATE_MODEL_OPUS_FALLBACK", "oai/gpt-5.4-opus")
