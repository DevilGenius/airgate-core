...
var usageLogListFields = []string{
	...
	entusagelog.FieldFirstEventMs,
	entusagelog.FieldFirstTokenMs,
	entusagelog.FieldWsDialMs,
...
func mapUsageLog(item *ent.UsageLog) appusage.LogRecord {
	...
	if item.Edges.Account != nil {
		...
		record.AccountDeleted = item.Edges.Account.DeletedAt != nil
		if item.Edges.Account.Email != nil {
