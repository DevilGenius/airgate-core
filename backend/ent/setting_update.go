...
func (su *SettingUpdate) SetGroup(s string) *SettingUpdate {
	su.mutation.SetGroup(s)
	return su
}

// SetNillableGroup sets the "group" field if the given value is not nil.
func (su *SettingUpdate) SetNillableGroup(s *string) *SettingUpdate {
	if s != nil {
		su.SetGroup(*s)
	}
	return su
...
// SetGroup sets the "group" field.
func (suo *SettingUpdateOne) SetGroup(s string) *SettingUpdateOne {
	suo.mutation.SetGroup(s)
	return suo
}

// SetNillableGroup sets the "group" field if the given value is not nil.
func (suo *SettingUpdateOne) SetNillableGroup(s *string) *SettingUpdateOne {
	if s != nil {
		suo.SetGroup(*s)
	}
	return suo
