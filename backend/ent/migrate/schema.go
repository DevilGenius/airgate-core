...
var (
	...
	APIKeysColumns = []*schema.Column{
		...
		{Name: "max_non_responses_rpm", Type: field.TypeInt, Default: 0},
	...
	MonitorEventsColumns = []*schema.Column{
		{Name: "id", Type: field.TypeInt, Increment: true},
		{Name: "type", Type: field.TypeEnum, Enums: []string{"scheduler_error", "upstream_account_error", "plugin_error", "task_error", "system_error"}},
		{Name: "severity", Type: field.TypeEnum, Enums: []string{"info", "warning", "error", "critical"}, Default: "warning"},
		{Name: "status", Type: field.TypeEnum, Enums: []string{"active", "resolved"}, Default: "active"},
		{Name: "recovery_mode", Type: field.TypeEnum, Enums: []string{"none", "manual", "success", "external"}, Default: "none"},
	...
	MonitorEventsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{MonitorEventsColumns[3], MonitorEventsColumns[20]},
			},
			{
	...
	// MonitorRequestEventsColumns holds the columns for the "monitor_request_events" table.
	MonitorRequestEventsColumns = []*schema.Column{
		{Name: "id", Type: field.TypeInt, Increment: true},
	...
	// MonitorRequestEventsTable holds the schema information for the "monitor_request_events" table.
	MonitorRequestEventsTable = &schema.Table{
		Name:       "monitor_request_events",
		Columns:    MonitorRequestEventsColumns,
		PrimaryKey: []*schema.Column{MonitorRequestEventsColumns[0]},
		Indexes: []*schema.Index{
			{
	...
	UsageLogsColumns = []*schema.Column{
		{Name: "id", Type: field.TypeInt, Increment: true},
		{Name: "billing_event_id", Type: field.TypeString},
		{Name: "platform", Type: field.TypeString},
		...
		{Name: "duration_ms", Type: field.TypeInt64, Default: 0},
		{Name: "first_event_ms", Type: field.TypeInt64, Default: 0},
		{Name: "first_token_ms", Type: field.TypeInt64, Default: 0},
		{Name: "ws_dial_ms", Type: field.TypeInt64, Default: 0},
	...
	UsageLogsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			{
				Name:    "usage_log_billing_event_id",
				Unique:  true,
			...
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{UsageLogsColumns[2], UsageLogsColumns[37]},
			},
			{
				Name:    "usage_log_user_snapshot_created_at",
				Unique:  false,
				Columns: []*schema.Column{UsageLogsColumns[35], UsageLogsColumns[37]},
			},
			{
				Name:    "usage_log_user",
				Unique:  false,
