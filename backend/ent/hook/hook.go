...
// The MonitorEventFunc type is an adapter to allow the use of ordinary
// function as MonitorEvent mutator.
type MonitorEventFunc func(context.Context, *ent.MonitorEventMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f MonitorEventFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.MonitorEventMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.MonitorEventMutation", m)
}

// The MonitorRequestEventFunc type is an adapter to allow the use of ordinary
// function as MonitorRequestEvent mutator.
type MonitorRequestEventFunc func(context.Context, *ent.MonitorRequestEventMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f MonitorRequestEventFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.MonitorRequestEventMutation); ok {
		return f(ctx, mv)
	}
