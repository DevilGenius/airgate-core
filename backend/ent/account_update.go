...
func (au *AccountUpdate) SetUsageEstimateMeta(am accountusage.EstimateMeta) *AccountUpdate {
	au.mutation.SetUsageEstimateMeta(am)
	return au
}

// SetNillableUsageEstimateMeta sets the "usage_estimate_meta" field if the given value is not nil.
func (au *AccountUpdate) SetNillableUsageEstimateMeta(am *accountusage.EstimateMeta) *AccountUpdate {
	if am != nil {
		au.SetUsageEstimateMeta(*am)
	}
	return au
}

// ClearUsageEstimateMeta clears the value of the "usage_estimate_meta" field.
func (au *AccountUpdate) ClearUsageEstimateMeta() *AccountUpdate {
	au.mutation.ClearUsageEstimateMeta()
	return au
}
...
func (au *AccountUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := au.mutation.UsageEstimateMeta(); ok {
		_spec.SetField(account.FieldUsageEstimateMeta, field.TypeJSON, value)
	}
	if au.mutation.UsageEstimateMetaCleared() {
		_spec.ClearField(account.FieldUsageEstimateMeta, field.TypeJSON)
	}
...
// SetUsageEstimateMeta sets the "usage_estimate_meta" field.
func (auo *AccountUpdateOne) SetUsageEstimateMeta(am accountusage.EstimateMeta) *AccountUpdateOne {
	auo.mutation.SetUsageEstimateMeta(am)
	return auo
}

// SetNillableUsageEstimateMeta sets the "usage_estimate_meta" field if the given value is not nil.
func (auo *AccountUpdateOne) SetNillableUsageEstimateMeta(am *accountusage.EstimateMeta) *AccountUpdateOne {
	if am != nil {
		auo.SetUsageEstimateMeta(*am)
	}
	return auo
}

// ClearUsageEstimateMeta clears the value of the "usage_estimate_meta" field.
func (auo *AccountUpdateOne) ClearUsageEstimateMeta() *AccountUpdateOne {
	auo.mutation.ClearUsageEstimateMeta()
	return auo
}
...
func (auo *AccountUpdateOne) sqlSave(ctx context.Context) (_node *Account, err error) {
	...
	if value, ok := auo.mutation.UsageEstimateMeta(); ok {
		_spec.SetField(account.FieldUsageEstimateMeta, field.TypeJSON, value)
	}
	if auo.mutation.UsageEstimateMetaCleared() {
		_spec.ClearField(account.FieldUsageEstimateMeta, field.TypeJSON)
	}
