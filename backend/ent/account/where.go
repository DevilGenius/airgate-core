...
// UsageEstimateMetaIsNil applies the IsNil predicate on the "usage_estimate_meta" field.
func UsageEstimateMetaIsNil() predicate.Account {
	return predicate.Account(sql.FieldIsNull(FieldUsageEstimateMeta))
}

// UsageEstimateMetaNotNil applies the NotNil predicate on the "usage_estimate_meta" field.
func UsageEstimateMetaNotNil() predicate.Account {
	return predicate.Account(sql.FieldNotNull(FieldUsageEstimateMeta))
}
