...
func (ac *AccountCreate) SetUsageEstimateMeta(am accountusage.EstimateMeta) *AccountCreate {
	ac.mutation.SetUsageEstimateMeta(am)
	return ac
}

// SetNillableUsageEstimateMeta sets the "usage_estimate_meta" field if the given value is not nil.
func (ac *AccountCreate) SetNillableUsageEstimateMeta(am *accountusage.EstimateMeta) *AccountCreate {
	if am != nil {
		ac.SetUsageEstimateMeta(*am)
	}
	return ac
}
...
func (ac *AccountCreate) defaults() {
	...
	if _, ok := ac.mutation.UsageEstimateMeta(); !ok {
		v := account.DefaultUsageEstimateMeta
		ac.mutation.SetUsageEstimateMeta(v)
	}
...
func (ac *AccountCreate) createSpec() (*Account, *sqlgraph.CreateSpec) {
	...
	if value, ok := ac.mutation.UsageEstimateMeta(); ok {
		_spec.SetField(account.FieldUsageEstimateMeta, field.TypeJSON, value)
		_node.UsageEstimateMeta = value
	}
