...
| Layer | Tech |
|---|---|
| Backend | Go 1.26.5 · Gin · Ent ORM · PostgreSQL 17 · Redis 8 |
...
Requires Go 1.26.5+, Node 22+, local Postgres + Redis, and the sibling [`airgate-sdk`](https://github.com/DevilGenius/airgate-sdk) repo:
